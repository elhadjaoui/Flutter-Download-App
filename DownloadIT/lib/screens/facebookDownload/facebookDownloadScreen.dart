...
import 'package:reddit_video_downloader/screens/facebookDownload/facebookData.dart';
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: MyButton(
                                          ...
                                          onPressed: _hasAudio
                                              ? () async {
                                                  _fbScaffoldKey.currentState.showSnackBar(mySnackBar(context, 'Start Downloading'));
