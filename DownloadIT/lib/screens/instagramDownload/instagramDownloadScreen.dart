...
import 'package:reddit_video_downloader/helper/showToast.dart';
import 'package:reddit_video_downloader/screens/instagramDownload/InstaData.dart';


Directory dir = Directory('/storage/emulated/0/DownloadIt/Instagram');
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: MyButton(
                                          ...
                                          onPressed: () async {
                                            _igScaffoldKey.currentState.showSnackBar(mySnackBar(context, 'Start Downloading'));
